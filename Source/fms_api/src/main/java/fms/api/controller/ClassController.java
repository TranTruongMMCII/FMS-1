...
public class ClassController {
	...
	public ResponseEntity<Class> getClassById(@PathVariable(value = "classID") long classID) throws ResourceNotFoundException{
		Class classs = 
				classRepository
	...
	public ResponseEntity<Class> updateClass(@PathVariable(value = "classID") long classID, @Validated @RequestBody Class classDetails) throws ResourceNotFoundException{
		...
		classs.setCapacity(classDetails.getCapacity());
	...
	public Map<String, Boolean> deleteClass(@PathVariable(value = "classID") long classID) throws ResourceNotFoundException{
		Class classs = classRepository
				.findById(classID)
				.orElseThrow(() -> new ResourceNotFoundException("User not found ::" + classID));
